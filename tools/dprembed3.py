...
with open("output.jsonl", "r") as f_in, open("output-embed.jsonl", "w") as f_out:
    ...
    for line in f_in:
        ...
        for token_window in token_windows:
            ...
            window_embedding = model(input_ids).pooler_output.tolist()[0]
        ...
        f_out.write(json.dumps({"ID": obj["ID"], "Title": obj["Title"], "Text": obj["Text"], "Tokens": obj["Tokens"], "Embeddings": embeddings}) + "\n")
